        ...
        open: function(options) {
            ...
            if ($('#' + obj.name + 'w2ui-window').length === 0) {
                ...
                if (options.showClose) {
                    btn += '<a class="close" data-panel="' + obj.name + '" data-action="close" onmousedown="event.stopPropagation()" onclick="w2panel.action(event)">&nbsp;</a>';
                }
                if (options.showMax) {
                    btn += '<a class="expand" data-panel="' + obj.name + '" data-action="toggle" onmousedown="event.stopPropagation()" onclick="w2panel.action(event)">&nbsp;</a>';
                }
                if (options.showMin) {
                    btn += '<a class="minimize" data-panel="' + obj.name + '" data-action="min" onmousedown="event.stopPropagation()" onclick="w2panel.action(event)">&nbsp;</a>';
                }
                btn += '</div>';
